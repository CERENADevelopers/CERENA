...
options.ode45.reltol = 1e-8;
options.ode45.abstol = 1e-8;
...
reltol = options.ode45.reltol;
abstol = options.ode45.abstol;
options_ode45 = odeset('RelTol',reltol,'AbsTol',abstol);
x = simulateFSP(model,t,options_ode45); % Probabilities of FSP states
