% simulate_geneExp_MM2.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_geneExp_MM2(tout,theta)
% [...] = simulate_geneExp_MM2(tout,theta,kappa,options)
% sol = simulate_geneExp_MM2(...)
% [status,tout,x,y,sx,sy] = simulate_geneExp_MM2(...)
%
% INPUTS:
% =======
...
function varargout = simulate_geneExp_MM2(varargin)
...
options_cvode.nnz = 68; % MUST NOT CHANGE THIS VALUE
...
cw_geneExp_MM2(sol,tout,theta(1:10),kappa(1:29),options_cvode,plist,pbar,xscale);
rt = [6   7   3   8   1   9  10  14  11  12  13   2   5   4];
sol.x = sol.x(:,rt);
