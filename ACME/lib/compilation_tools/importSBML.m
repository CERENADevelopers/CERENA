...
fprintf(fid, ['System.state.mu0         = sym(transpose([', num2str(System.state.mu0),']));\n']);
fprintf(fid,  'System.state.C0          = sym(zeros(System.state.number*(System.state.number+1)/2,1));\n');
