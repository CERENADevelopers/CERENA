...
fprintf(fid,['%% simulate_' filename '.m is the matlab interface to the cvodes mex\n'...
    ...
    '%%        0: AMD (online) reordering\n'...
    '%%        1: COLAMD (online) reordering\n'...
    '%%        2: AMD (offline) or natural depending on whether noreorder was set or not during compilation.\n'...
    '%%\n'...
    '%% Outputs:\n'...
    '%% ========\n'...
...
fprintf(fid,['options_cvode.ordering = 2;\n\n']);
