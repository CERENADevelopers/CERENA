...
System.parameter.variable = [ k_1 ; k_2 ; k_3 ; k_4 ; STAT_total_conc; Omega_cyt; Omega_nuc; ...
                              offset_pSTAT; offset_tSTAT; scale_pSTAT; scale_tSTAT; sp1; sp2; sp3; sp4; sp5];
...
System.input.function = [ pEpoR ];
% System.input.function = [ (b*time^2)*exp(-a*time) ];
% System.input.function = @(t,theta) spline_pos5_matlab(t, 0.0, theta(12), 5.0, theta(13), 10.0, theta(14), 20.0, theta(15), 60.0, theta(16), 0, 0.0);
